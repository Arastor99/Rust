  ...
  const material = [
    {
      ...
      name: "Madera",
      value: 'wood',
      img: <img className="h-8 w-8" src="./public/resources/wood.png" />,
    },
    {
      id: 2,
      name: "Piedra",
      value: 'stone',
      img: <img className="h-8 w-8" src="./public/resources/stone.png" />,
    },
    {
      id: 3,
      name: "Metal",
      value: 'metal',
      img: <img className="h-8 w-8" src="./public/resources/metal.png" />,
    },
    {
      id: 4,
      name: "Metal de alta calidad",
      value: 'hq',
      img: <img className="h-8 w-8" src="./public/resources/hq.png" />,
    },
    {
      id: 5,
      name: "Puerta de madera",
      value: 'dw',
      img: <img className="h-8 w-8" src="./public/resources/dw.png" />,
    },
    {
      id: 6,
      name: "Puerta de metal",
      value: 'dm',
      img: <img className="h-8 w-8" src="./public/resources/dm.png" />,
    },
    {
      id: 7,
      name: "Puerta de garaje",
      value: 'dg',
      img: <img className="h-8 w-8" src="./public/resources/dg.png" />,
    },
    {
      id: 8,
      name: "Puera armored",
      value: 'dq',
      img: <img className="h-8 w-8" src="./public/resources/dq.png" />,
    },
  ];
