      ...
      <div className=" h-screen ">
        ...
        {/*
          <div className="overflow-x-scroll md:overflow-x-auto">
            <table className="mt-4 mx-auto min-w-full">
              <thead>
                <tr>
                  ...
                  <th className="px-4 py-2">Sulfur</th>
                </tr>
              </thead>
              <div className="flex items-center space-x-2">
                ...
                >
                  ...
                  <span className="ml-2 text-gray-700">Melee</span>
                </label>
                <label
                  htmlFor="explosives"
                  className="flex items-center cursor-pointer "
                >
                  ...
                  <span className="ml-2 text-gray-700">Explosives</span>
                </label>
              </div>
              <tbody id="raiditems">
                {filteredExplosives.map((item) => (
                  <tr
                    key={item.id}
                    typedata={item.type}
                    className={item.type === "melee" ? "hide-row" : ""}
                  >
                    <td className="px-4 py-2 bg-gray-700">
                    ...
                    <td className="px-4 py-2 bg-gray-700">{item.quantity}</td>
                    <td className="px-4 py-2 bg-gray-700">{item.time}</td>
                    <td className="px-4 py-2 bg-gray-700">{item.fuel}</td>
                    <td className="px-4 py-2 bg-gray-700">{item.sulfur}</td>
                  </tr>
                ))}
              </tbody>
            </table>
